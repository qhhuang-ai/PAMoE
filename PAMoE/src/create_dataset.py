...
class MOSI:
    def __init__(self, config):
        ...
        try:
            ...
            pickle_filename = DATA_PATH + '/mosi_data_noalign.pkl'
            csv_filename = DATA_PATH + '/MOSI-label.csv'
...
class MOSEI:
    def __init__(self, config):
        ...
        try:
            ...
            # load pickle file for unaligned acoustic and visual source
            # pickle_filename = '/home/lzh/codes/PAMoE-MSA/data/MOSEI/mosei_senti_data_noalign.pkl'
